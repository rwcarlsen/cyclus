...
class Trader {
 public:
  Trader(Model* supervisor) : supervisor_(supervisor) {};

  virtual Model* supervisor() {return supervisor_;};
  ...
  virtual void SetMatlPrefs(PrefMap<Material>::type& prefs) {};
  
  /// @brief default implementation for material preferences
  virtual void SetGenRsrcPrefs(PrefMap<GenericResource>::type& prefs) {};
